...
public class DataModelTokoBuku {
  ...
  public void addBarang(int IDcustomer, Barang brg) throws SQLException {
    String insertCustomer = "INSERT INTO barang (IDcustomer, jenisBuku, hargaBuku)"
            + "VALUES (?,?,?)";
    PreparedStatement statCustomer = conn.prepareStatement(insertCustomer);
    statCustomer.setInt(1, IDcustomer);
